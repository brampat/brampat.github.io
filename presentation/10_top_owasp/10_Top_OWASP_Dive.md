...
![](./pics/OWASP/SAMM_logo.png)<!-- .element style="position: fixed; box-shadow:none; width: 250px; top: 10px; left: 240px; "  -->
<div class="flags">
...
![](./pics/OWASP/DSOMM_logo.png)<!-- .element style="position: fixed; box-shadow:none; width: 250px; top: 0px; left: 240px; "  -->
<div class="flags">
...
![](./pics/OWASP/Cornucopia-card-session-9.png)<!-- .element style="position: fixed; width: 300px; top: 100px; right: 10px;" -->

![](./pics/OWASP/Cornucopia_cards.png)<!-- .element style="position: fixed; box-shadow:none; width: 650px; top: 150px; right: 350px;" -->
...
![](./pics/OWASP/Threat_dragon.png)<!-- .element style="position: fixed; box-shadow:none; width: 250px; top: 100px; right: 0px;" -->

![](./pics/OWASP/Threat_dragon_example.png)<!-- .element style="position: fixed; width: 750px; top: 150px; right: 300px;" -->
...
![](./pics/OWASP/RaspPi_JuiceShop_case_1.3.png)<!-- .element class="center-y" style="position: fixed; box-shadow:none; width: 500px; right: 60px;"  -->

![](./pics/OWASP/RaspPi_Manual_1.png)<!-- .element style="position: fixed; width: 150px; right: -80px; top: 100px;"  -->
![](./pics/OWASP/RaspPi_Manual_2.png)<!-- .element style="position: fixed; width: 150px; right: -80px; top: 220px;"  -->
![](./pics/OWASP/RaspPi_Manual_3.png)<!-- .element style="position: fixed; width: 150px; right: -80px; top: 340px;"  -->
