...
<span>Next ed. 2025 'H1</span><!-- .element class="fragment center-x" style="font-size: 25px; position: fixed; bottom: 50px; width: 800px;" -->
...
<div class="flags">
 <i class="fas fa-xs fa-egg" title="Incubator"></i>
 <i class="fas fa-xs fa-book" title="Documentation"></i>
 <i class="fas fa-xs fa-toolbox" title="Builder"></i>
 <i class="fas fa-xs fa-shield" title="Defender"></i>
...
<div class="flags">
 ...
 <i class="fas fa-xs fa-toolbox" title="Builder"></i>
 <i class="fas fa-xs fa-shield" title="Defender"></i>
 <a class="fas fa-xs fa-external-link" target="_blank" href="https://owasp.org/www-project-top-10-for-large-language-model-applications/"> </a>
</div>

![](./pics/OWASP_top10/OWASP_Top_10_LLM.jpg)<!-- .element style="position: fixed; box-shadow:none; width: 250px; bottom: 20px; right: 250px;"  -->
![](./pics/OWASP/GenAI_Security_Project.png)<!-- .element style="position: fixed; box-shadow:none; width: 400px; top: 120px; right: 0px;"  -->
...
* Document contains:
  ...
  * Examples of risks and attack scenario's
  * References to blogs & articles
  * MITRE AML references

-- Notes --

* Part of GenAI Security Project 
* Another important OWASP AI project later


--

## 1.9.2: Machine Learning Top 10
<hr />
...
<div class="flags">
 ...
 <i class="fas fa-xs fa-shield" title="Defender"></i>
 <i class="fas fa-xs fa-user-secret" title="Breaker"></i>
 <a class="fas fa-xs fa-external-link" target="_blank" href="https://owasp.org/www-project-machine-learning-security-top-10/"> </a>
</div>
